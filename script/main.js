...
function addPresetMarkers() {
    var places = [
        ...
        { lat: 52.4222, lon: 31.0168, name: 'Дворец Румянцевых - Паскевичей', address: 'пл. Ленина 4', type: 'showplace', info: 'Легендарный дворец XVIII века в стиле неоклассицизма, где сейчас расположен культурно-исторический музей.',image: ['image/rumancev/home.png', 'image/rumancev/zal.png', 'image/rumancev/bogato.png'],link:"<a href='https://www.palacegomel.by' target='_blank' class='link'>подробнее...</a>" },
        { lat: 52.4252, lon: 31.0140, name: 'Кирилл Туровский', address: 'Ул.Советская 1', type: 'showplace', info: 'Исторический памятник',image: ['image/turav/kiriil.png', 'image/turav/place.png']},
        { lat: 52.4342, lon: 31.0090, name: 'Карандаш, памятник, мемориал, Гомель', address: 'Ул.Советская 27', type: 'showplace', info: 'Скульптура',image: ['image/Pen/karandash.png', 'image/Pen/karandashPlace.png']},
        { lat: 52.4240, lon: 31.0182, name: 'Часовня-усыпальница Паскевичей', address: 'пл. Ленина 4', type: 'showplace', info: 'Часовня',image: ['image/timePalac/Palac.png', 'image/timePalac/PalacVnutr.png'],link:"<a href='https://www.palacegomel.by' target='_blank' class='link'>подробнее...</a>" },
